"use client";
import { useCreateEmployeeMutation, useGetEmployeeQuery } from "@/lib/services/employeeService";
...
export default function Page() {
  ...
  const [createEmployee, { isSuccess, isLoading, isError }] = useCreateEmployeeMutation();
